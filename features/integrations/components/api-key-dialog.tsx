...
const PROVIDER_CONFIGS: Record<string, ProviderConfig> = {
  ...
  hubspot: {
    ...
    color: "#ff7a59",
    initial: "H",
    tagline: "Create and update CRM contacts and deals directly from agent conversations.",
    keyPlaceholder: "pat-…",
    docsUrl: "https://app.hubspot.com/login",
    docsLabel: "Get API key from HubSpot",
    models: [],
  },
  slack: {
    provider: "slack",
    ...
    color: "#4a154b",
    initial: "Sl",
    tagline: "Post messages and alerts to Slack channels from your agents.",
    keyPlaceholder: "xoxb-…",
    docsUrl: "https://api.slack.com/apps",
    docsLabel: "Get bot token from Slack API",
    models: [],
  },
  razorpay: {
    provider: "razorpay",
    ...
    color: "#072654",
    initial: "Rz",
    tagline: "Create payment links and check order status during voice calls.",
    keyPlaceholder: "rzp_live_…",
    docsUrl: "https://dashboard.razorpay.com/app/keys",
    docsLabel: "Get API key from Razorpay Dashboard",
    models: [],
  },
  stripe: {
    provider: "stripe",
    ...
    color: "#635bff",
    initial: "St",
    tagline: "Create payment links and retrieve customer billing details.",
    keyPlaceholder: "sk_live_…",
    docsUrl: "https://dashboard.stripe.com/apikeys",
    docsLabel: "Get API key from Stripe Dashboard",
    models: [],
  },
  twilio: {
    provider: "twilio",
    ...
    color: "#f22f46",
    initial: "Tw",
    tagline: "Phone number management and PSTN calls. Most widely supported telephony provider.",
    keyPlaceholder: "ACxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
    docsUrl: "https://console.twilio.com/",
    docsLabel: "Get credentials from Twilio Console",
    models: [],
  },
  telnyx: {
    provider: "telnyx",
    ...
    color: "#00c08b",
    initial: "Te",
    tagline: "Carrier-grade telephony with competitive per-minute rates.",
    keyPlaceholder: "KEY…",
    docsUrl: "https://portal.telnyx.com/",
    docsLabel: "Get API key from Telnyx Portal",
    models: [],
  },
  vonage: {
    provider: "vonage",
    ...
    color: "#7c1d7c",
    initial: "Vo",
    tagline: "Voice API with global coverage and programmable PSTN.",
    keyPlaceholder: "…",
    docsUrl: "https://dashboard.nexmo.com/",
    docsLabel: "Get API key from Vonage Dashboard",
    models: [],
  },
  gupshup: {
    provider: "gupshup",
    ...
    color: "#25d366",
    initial: "Gu",
    tagline: "WhatsApp Business API. Most cost-effective option for India.",
    keyPlaceholder: "…",
    docsUrl: "https://www.gupshup.io/",
    docsLabel: "Get API key from Gupshup",
    models: [],
  },
  sarvam: {
    provider: "sarvam",
    ...
    color: "#f97316",
    initial: "Sa",
    tagline: "STT and TTS for Indian languages — Hindi, Tamil, Telugu, Marathi, Bengali, Gujarati, Kannada, Malayalam.",
    keyPlaceholder: "…",
    docsUrl: "https://dashboard.sarvam.ai/",
    docsLabel: "Get API key from Sarvam AI Dashboard",
    models: [],
  },
};
...
export function ApiKeyDialog({ provider, onOpenChange }: ApiKeyDialogProps) {
        ...
        {config ? (
          <>
            ...
            <div className="space-y-5 py-1">
              ...
              {/* Available models (only when there are models to show) */}
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1.5">
                    {config.models.map((m) => (
                      <div
                        key={m.name}
                        className="flex items-center justify-between py-1.5 px-3 rounded-lg bg-muted/40 border border-border/40"
                      >
          ...
          <p className="text-sm text-muted-foreground py-4 text-center">Provider not supported.</p>
        )}
      </DialogContent>
    </Dialog>
  );
